# -*- coding: utf-8 -*-
"""simple_distributions_debugged.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1M-naZMgIgeYs9A4dTxKIdKyc6WJDrvuj
"""
...
def get_composition_samples(params, sampler_type, composition_type, batch_size=1000, seed=0):
    """
...
if __name__ == "__main__":
  for algebra in ['product', 'summation', 'negation']:
    for suffix in ['a1', 'a2', 'b1', 'b2', 'c1', 'c2']:
      ...
      spiral_params = training_results['ema_params']
      # save params
      with open(f'exps/{algebra}_{suffix}/ema_model.pkl', 'wb') as f:
          pickle.dump(spiral_params, f)
  ...
  for algebra in ['product', 'summation', 'negation']:
    for suffix in ["a", "b", "c"]:
      ...
      for idx, sampler_type in enumerate(['ULA', 'MALA', 'UHA', 'MUHA']):
          x_samp, grad_sample = get_composition_samples(params, sampler_type, 'product')
          axs[idx].scatter(x_samp[:, 0], x_samp[:, 1], color='green', alpha=.5)
          # axs[idx].scatter(grad_sample[:, 0], grad_sample[:, 1], color='blue', alpha=.5)
