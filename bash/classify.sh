...
python -m scripts.label_images_clevr_pos num_constraints=2 +image_dir=runs/11-07-23-10-44_rejection_clevr_pos_2/test_clevr_pos_5000_2
python -m scripts.label_images_clevr_pos num_constraints=3 +image_dir=runs/11-07-16-30-22_rejection_clevr_pos_3/test_clevr_pos_5000_3
python -m scripts.label_images_clevr_pos num_constraints=4 +image_dir=runs/11-07-08-06-39_rejection_clevr_pos_4/test_clevr_pos_5000_4
